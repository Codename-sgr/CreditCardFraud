...
public class VendorServiceImpl implements VendorService{
	...
	public List<VendorBean> getVendorDetails() {
		...
		Collection<VendorEntity> vendorList = vendorDAO.findAll();
		for(VendorEntity entity: vendorList) {
	...
	@Override
	public VendorBean getVendorDetailsbyId(String vendorId) {
		VendorBean bean  = new VendorBean() ;
		VendorEntity entity  = vendorDAO.findOne(vendorId) ;
		BeanUtils.copyProperties(entity, bean);
		return bean;
	} 
